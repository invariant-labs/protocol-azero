...
pub mod contract {
    ...
    pub mod e2e_tests {
        use crate::contracts::logic::get_liquidity_by_x;
        ...
        async fn cross_both_side_test(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let mint = massive_x * 3;
            mint!(TokenRef, client, token_x, Alice, mint);
            mint!(TokenRef, client, token_y, Alice, mint);
            ...
            let lower_tick_index = -20;
            let upper_tick_index = 0;
            let amount_x = TokenAmount(massive_x);
            let massive_liquidity_delta = get_liquidity_by_x(
                amount_x,
                lower_tick_index,
                upper_tick_index,
                current_price,
