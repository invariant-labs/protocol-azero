...
pub const POSITION_SIZE: usize = POOL_KEY_SIZE + 128 + 32 + 32 + 256 + 16 + 256 + 16 + 64 + 128 + 128 + 128 + 64;
pub const POOL_SIZE: usize = 128 + 128 + 32 + 256 + 16 + 256 + 16 +  128 + 128 + 64 + 64 + ACCOUNT_ID_SIZE + 128;
...
#[wasm_wrapper]
pub fn get_max_swap_steps() -> i32 {
    MAX_SWAP_STEPS
}

#[wasm_wrapper]
pub fn get_search_range() -> i32 {
    TICK_SEARCH_RANGE
}
